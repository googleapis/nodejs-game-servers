...
describe('v1beta.RealmsServiceClient', () => {
    ...
    describe('getRealm', () => {
        it('invokes getRealm without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gaming.v1beta.GetRealmRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.gaming.v1beta.Realm());
            client.innerApiCalls.getRealm = stubSimpleCall(expectedResponse);
            const [response] = await client.getRealm(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getRealm as SinonStub)
        ...
        it('invokes getRealm with error', async () => {
            ...
            await assert.rejects(async () => { await client.getRealm(request); }, expectedError);
            assert((client.innerApiCalls.getRealm as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('previewRealmUpdate', () => {
        it('invokes previewRealmUpdate without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.gaming.v1beta.PreviewRealmUpdateResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.previewRealmUpdate as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes previewRealmUpdate with error', async () => {
            ...
            await assert.rejects(async () => { await client.previewRealmUpdate(request); }, expectedError);
            assert((client.innerApiCalls.previewRealmUpdate as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createRealm', () => {
        it('invokes createRealm without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gaming.v1beta.CreateRealmRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createRealm as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createRealm with call error', async () => {
            ...
            await assert.rejects(async () => { await client.createRealm(request); }, expectedError);
            assert((client.innerApiCalls.createRealm as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteRealm', () => {
        it('invokes deleteRealm without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gaming.v1beta.DeleteRealmRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteRealm as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteRealm with call error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteRealm(request); }, expectedError);
            assert((client.innerApiCalls.deleteRealm as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateRealm', () => {
        it('invokes updateRealm without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gaming.v1beta.UpdateRealmRequest());
            request.realm = {};
            request.realm.name = '';
            const expectedHeaderRequestParams = "realm.name=";
            const expectedOptions = {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateRealm as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateRealm with call error', async () => {
            ...
            await assert.rejects(async () => { await client.updateRealm(request); }, expectedError);
            assert((client.innerApiCalls.updateRealm as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listRealms', () => {
        it('invokes listRealms without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gaming.v1beta.ListRealmsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listRealms as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listRealms with error', async () => {
            ...
            await assert.rejects(async () => { await client.listRealms(request); }, expectedError);
            assert((client.innerApiCalls.listRealms as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
