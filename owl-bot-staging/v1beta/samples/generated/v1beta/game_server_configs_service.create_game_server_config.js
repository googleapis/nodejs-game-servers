...
function main(parent, configId, gameServerConfig) {
  // [START gaming_v1beta_generated_GameServerConfigsService_CreateGameServerConfig_async]
  /**
  ...
  // [END gaming_v1beta_generated_GameServerConfigsService_CreateGameServerConfig_async]
}
