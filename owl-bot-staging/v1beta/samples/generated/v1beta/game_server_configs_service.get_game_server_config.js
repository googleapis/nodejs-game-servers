...
function main(name) {
  // [START gaming_v1beta_generated_GameServerConfigsService_GetGameServerConfig_async]
  /**
  ...
  getGameServerConfig();
  // [END gaming_v1beta_generated_GameServerConfigsService_GetGameServerConfig_async]
}
