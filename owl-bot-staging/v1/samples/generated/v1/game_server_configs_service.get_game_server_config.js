...
function main(name) {
  // [START gaming_v1_generated_GameServerConfigsService_GetGameServerConfig_async]
  /**
  ...
  getGameServerConfig();
  // [END gaming_v1_generated_GameServerConfigsService_GetGameServerConfig_async]
}
