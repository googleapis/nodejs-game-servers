...
describe('v1.GameServerConfigsServiceClient', () => {
    ...
    describe('getGameServerConfig', () => {
        it('invokes getGameServerConfig without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.gaming.v1.GameServerConfig());
    ...
    describe('createGameServerConfig', () => {
        it('invokes createGameServerConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gaming.v1.CreateGameServerConfigRequest());
            request.parent = '';
    ...
    describe('deleteGameServerConfig', () => {
        it('invokes deleteGameServerConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gaming.v1.DeleteGameServerConfigRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listGameServerConfigs', () => {
        it('invokes listGameServerConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.gaming.v1.ListGameServerConfigsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
