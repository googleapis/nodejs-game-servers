...
describe('v1.RealmsServiceClient', () => {
    ...
    describe('getRealm', () => {
        it('invokes getRealm without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.gaming.v1.Realm());
    ...
    describe('previewRealmUpdate', () => {
        it('invokes previewRealmUpdate without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.gaming.v1.PreviewRealmUpdateResponse());
